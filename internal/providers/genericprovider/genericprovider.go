...
func (p GenericProvider) GetUserInfo(_ context.Context, _ string, accessToken *oauth2.Token, idToken info.Claimer, providerMetadata map[string]interface{}) (info.User, error) {

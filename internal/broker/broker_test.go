...
func TestSelectAuthenticationMode(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"Successfully select device_auth":    {supportedLayouts: supportedLayoutsWithoutQrCode, modeName: authmodes.DeviceID},
...
func TestIsAuthenticated(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"Successfully authenticate user with link code and newpassword": {firstMode: authmodes.DeviceID, firstChallenge: "-", wantSecondCall: true},
		...
		"Authenticating with link code reacquires token":       {firstMode: authmodes.DeviceID, firstChallenge: "-", wantSecondCall: true, preexistentToken: "valid"},

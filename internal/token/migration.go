...
func UseOldEncryptedToken(passwordPath, oldEncryptedTokenPath string) (bool, error) {
	exists, err := fileutils.FileExists(passwordPath)
	if err != nil {
	...
	exists, err = fileutils.FileExists(oldEncryptedTokenPath)
	if err != nil {
